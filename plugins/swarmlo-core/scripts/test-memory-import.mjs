#!/usr/bin/env node
/**
 * Regression guard for github.com/z451047442-debug/swarmlo#1883 + #1884.
 *
...
const posixCwd = '/Users/alice/projects/swarmlo';
const posixCandidates = deriveCandidates(posixCwd);
if (posixCandidates.has('-Users-alice-projects-swarmlo')) {

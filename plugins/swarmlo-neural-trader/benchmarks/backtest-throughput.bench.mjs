 ...
 *
 * Run:
 *   node plugins/swarmlo-neural-trader/benchmarks/backtest-throughput.bench.mjs
 *
...
console.log('- `plugins/swarmlo-neural-trader/skills/trader-backtest/SKILL.md` — production backtest path');

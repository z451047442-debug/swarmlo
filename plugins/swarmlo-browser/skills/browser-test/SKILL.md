...
allowed-tools: mcp__plugin_swarmlo-core_swarmlo__browser_open mcp__plugin_swarmlo-core_swarmlo__browser_click mcp__plugin_swarmlo-core_swarmlo__browser_fill mcp__plugin_swarmlo-core_swarmlo__browser_type mcp__plugin_swarmlo-core_swarmlo__browser_press mcp__plugin_swarmlo-core_swarmlo__browser_check mcp__plugin_swarmlo-core_swarmlo__browser_uncheck mcp__plugin_swarmlo-core_swarmlo__browser_select mcp__plugin_swarmlo-core_swarmlo__browser_hover mcp__plugin_swarmlo-core_swarmlo__browser_wait mcp__plugin_swarmlo-core_swarmlo__browser_screenshot mcp__plugin_swarmlo-core_swarmlo__browser_snapshot mcp__plugin_swarmlo-core_swarmlo__browser_get-text mcp__plugin_swarmlo-core_swarmlo__browser_get-title mcp__plugin_swarmlo-core_swarmlo__browser_get-url mcp__plugin_swarmlo-core_swarmlo__browser_get-value mcp__plugin_swarmlo-core_swarmlo__browser_eval mcp__plugin_swarmlo-core_swarmlo__browser_close mcp__plugin_swarmlo-core_swarmlo__browser_session-list mcp__plugin_swarmlo-core_swarmlo__aidefence_is_safe Bash Read Write
---
...
- The same skill, used in CI, now produces an artifact that `/swarmlo-browser replay` can re-drive.

...
node plugins/swarmlo-core/scripts/witness/init.mjs
...
node plugins/swarmlo-core/scripts/witness/verify.mjs --manifest verification.md.json
...
# Temporal queries
node plugins/swarmlo-core/scripts/witness/history.mjs --history verification-history.jsonl summary
node plugins/swarmlo-core/scripts/witness/history.mjs --history verification-history.jsonl regressions
node plugins/swarmlo-core/scripts/witness/history.mjs --history verification-history.jsonl timeline --id <fix-id>
```

See `plugins/swarmlo-core/skills/witness/SKILL.md` for the full workflow + anti-patterns.

 ...
 *
 * `swarmlo-knowledge-graph` builds an entity-relation graph via kg-extract.
...
export const KNOWLEDGE_GRAPH_ID = 'swarmlo-knowledge-graph:entities';

export class KnowledgeGraphAdapter implements SublinearAdapter {
  readonly graphId = KNOWLEDGE_GRAPH_ID;
  readonly ownerPlugin = 'swarmlo-knowledge-graph';

...
- **swarmlo-market-data**: OHLCV ingestion and candlestick pattern detection
...
Message schemas: `RegimeVerdict`, `SignalProposal`, `RiskDecision` in `plugins/swarmlo-neural-trader/src/pipeline-messages.ts`.

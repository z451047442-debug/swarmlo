#!/usr/bin/env bash
# Structural smoke test for swarmlo-cost-tracker v0.26.3.
set -u
...
step "6. README defers to swarmlo-agentdb namespace convention"
grep -q "swarmlo-agentdb" "$ROOT/README.md" \
...
grep -q "swarmlo-loop-workers" "$F" || miss="$miss cross-link"
[[ -z "$miss" ]] && ok || bad "$miss"

step "15. swarmlo-cost.md documents 'cost workers' subcommand with hooks_worker-status"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "26. swarmlo-cost.md documents 'cost benchmark' subcommand"
F="$ROOT/commands/swarmlo-cost.md"
...
SHIM="$ROOT/scripts/swarmlo-hook.cjs"
miss=""
[[ -f "$F" ]] || miss="$miss missing-file"
...
# requires scripts/swarmlo-hook.cjs, which does the track.mjs spawn + resilient
...
grep -q "swarmlo-hook\.cjs" "$F" || miss="$miss hooks-json-not-wired-to-shim"
...
step "30. swarmlo-cost.md documents 'cost track' subcommand"
F="$ROOT/commands/swarmlo-cost.md"
...
step "33. swarmlo-cost.md documents 'cost budget set/get/check' subcommands"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "36. swarmlo-cost.md documents 'cost outcome' subcommand"
grep -q "cost outcome" "$ROOT/commands/swarmlo-cost.md" \
  && ok || bad "missing"
...
step "39. swarmlo-cost.md documents 'cost trend' subcommand"
grep -q "cost trend" "$ROOT/commands/swarmlo-cost.md" \
  && ok || bad "missing"
...
step "39m. swarmlo-cost.md documents 'cost session' subcommand"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "39k. swarmlo-cost.md documents 'cost diff' subcommand"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "39i. swarmlo-cost.md documents 'cost health' subcommand"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "39g. swarmlo-cost.md documents 'cost anomaly' subcommand with alert flag"
F="$ROOT/commands/swarmlo-cost.md"
miss=""
...
step "39e. swarmlo-cost.md documents 'cost burn' subcommand with alert flag"
F="$ROOT/commands/swarmlo-cost.md"
miss=""

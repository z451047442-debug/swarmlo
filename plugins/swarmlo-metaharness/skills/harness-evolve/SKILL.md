...
Surfaces the upstream `metaharness-darwin evolve` CLI as a swarmlo skill. The
...
- For swarmlo itself in CI. ADR-153 §5 explicitly rejects auto-evolving swarmlo
...
and exits 0. swarmlo continues to function. CI's

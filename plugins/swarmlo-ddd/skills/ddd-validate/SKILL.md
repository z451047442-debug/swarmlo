...
argument-hint: ""
allowed-tools: Bash Read Grep Glob mcp__plugin_swarmlo-core_swarmlo__memory_store mcp__plugin_swarmlo-core_swarmlo__memory_search mcp__plugin_swarmlo-core_swarmlo__hooks_pre-task mcp__plugin_swarmlo-core_swarmlo__hooks_post-task
---
...
7. **Store results**:
   ```bash
   npx swarmlo-cli@3.39.1 memory store --key "ddd-validation-TIMESTAMP" --value "RESULTS_SUMMARY" --namespace tasks
   npx swarmlo-cli@3.39.1 hooks post-task --task-id "ddd-validate" --success true --store-results true
   ```

...
[[ -f "$ROOT/commands/swarmlo-sparc.md" ]] || miss="$miss missing-command"
[[ -z "$miss" ]] && ok || bad "$miss"
...
F="$ROOT/commands/swarmlo-sparc.md"
...
F="$ROOT/README.md"
miss=""
for plugin in swarmlo-adr swarmlo-ddd swarmlo-jujutsu swarmlo-docs swarmlo-goals; do

...
1. Call `mcp__plugin_swarmlo-core_swarmlo__workflow_list` to show all defined workflows
2. Call `mcp__plugin_swarmlo-core_swarmlo__workflow_template` to show available templates

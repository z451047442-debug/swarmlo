...
Display the current HAL GAIA leaderboard and compare with stored swarmlo runs.
...
...
 --   swarmlo (this session)    20.8    --     --     20.8*
```
...
| swarmlo iter 23 | 20.8% | 53 Q, post-SOTA web_search |
...
3. Load local runs: `npx swarmlo-cli@3.39.1 memory list --namespace gaia-runs`

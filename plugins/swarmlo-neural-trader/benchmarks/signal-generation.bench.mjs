 ...
 *
 * Run:
 *   node plugins/swarmlo-neural-trader/benchmarks/signal-generation.bench.mjs
 *
...
console.log('- `plugins/swarmlo-neural-trader/skills/trader-signal/SKILL.md` — production scan path');

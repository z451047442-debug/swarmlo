...
allowed-tools: mcp__plugin_swarmlo-core_swarmlo__browser_open mcp__plugin_swarmlo-core_swarmlo__browser_close mcp__plugin_swarmlo-core_swarmlo__browser_get-text mcp__plugin_swarmlo-core_swarmlo__browser_get-value mcp__plugin_swarmlo-core_swarmlo__browser_eval mcp__plugin_swarmlo-core_swarmlo__browser_snapshot mcp__plugin_swarmlo-core_swarmlo__browser_screenshot mcp__plugin_swarmlo-core_swarmlo__browser_scroll mcp__plugin_swarmlo-core_swarmlo__browser_wait mcp__plugin_swarmlo-core_swarmlo__browser_click mcp__plugin_swarmlo-core_swarmlo__aidefence_has_pii mcp__plugin_swarmlo-core_swarmlo__aidefence_is_safe mcp__plugin_swarmlo-core_swarmlo__aidefence_scan Bash Read Write
---
...
3. **Choose a path**:
   - **Template path** (`--template <name>`): retrieve from AgentDB and apply.
     ```bash
     npx -y swarmlo-cli@3.39.1 memory retrieve --namespace browser-templates --key "<name>"
     ```
...
4. **AIDefence pre-storage**: every extracted string passes the PII gate.
   ```bash
   # Pseudocode — mcp__plugin_swarmlo-core_swarmlo__aidefence_has_pii returns true/false per string.

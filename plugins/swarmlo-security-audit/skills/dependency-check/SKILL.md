...
allowed-tools: Bash(npx * npm *) mcp__plugin_swarmlo-core_swarmlo__memory_store Read
---
Check dependencies for CVEs and outdated packages:

```bash
npx swarmlo-cli@3.39.1 security cve --list
npx swarmlo-cli@3.39.1 security cve --severity critical
npx swarmlo-cli@3.39.1 security scan --type deps --depth deep
npm audit --json
```
...
Auto-fix via the scan command: `npx swarmlo-cli@3.39.1 security scan --type deps --fix`

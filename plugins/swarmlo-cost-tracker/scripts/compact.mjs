...
//      (script lives at <swarmlo>/plugins/swarmlo-cost-tracker/scripts/, the
//       integration package at <swarmlo>/v3/@claude-flow/integration/)
//
...
function tryAbsolutePath() {
  ...
  // Handles the marketplace layout (script at plugins/swarmlo-cost-tracker/scripts/) and the

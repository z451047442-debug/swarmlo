# Swarmlo v3.32.28: Agents That Know the Whole System
...
v3.32.28 introduces the Swarmlo Capability Brain: a live, machine-readable map of
...
```bash
npm install --global swarmlo@3.32.28
swarmlo doctor
```

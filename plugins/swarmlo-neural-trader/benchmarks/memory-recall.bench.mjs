 ...
 *
 * Measures `mcp__plugin_swarmlo-core_swarmlo__memory_search`-style latency over the
 ...
 *
 * Run:
 *   node plugins/swarmlo-neural-trader/benchmarks/memory-recall.bench.mjs
 *
...
console.log('- `plugins/swarmlo-neural-trader/skills/trader-backtest/SKILL.md` — production recall path');

...
//
// All swarmlo-metaharness skills shell out to the upstream CLI rather than
...
//      optionalDependencies in @claude-flow/cli + swarmlo package.json.
...
//      `npm install --prefix ~/.swarmlo/metaharness-cache-<pin>` versioned
...
// @claude-flow/cli/package.json + swarmlo/package.json. NEVER @latest.
...
// Exit 0 — ADR-150 architectural constraint says swarmlo continues to

#!/usr/bin/env node
/**
 * Package dependency overlap audit (regression guard for z451047442-debug/swarmlo#1147 and #2018).
 *
...
if (JSON_OUT) {
  ...
  if (issues.length === 0) {
    ...
    console.log(`\n${issues.length} issue(s) — see z451047442-debug/swarmlo#1147 and #2018 for context`);
  }
}

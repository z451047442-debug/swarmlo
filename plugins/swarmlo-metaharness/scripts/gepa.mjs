...
// 2. Fall back to a swarmlo-owned versioned cache install
//    (~/.swarmlo/darwin-cache-<pin>) — the versioned dir means pin bumps
...
function emitDegradedAndExit(reason) {
  ...
  process.exit(0);  // ADR-150 — swarmlo stays operational without MetaHarness
}

# Swarmlo Research Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with Swarmlo Research Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
The widget exposes a global `SwarmloResearchWidget` object:
...
- Customize via `SwarmloResearchWidgetConfig`
...
- Review console logs with `[Swarmlo Research]` prefix

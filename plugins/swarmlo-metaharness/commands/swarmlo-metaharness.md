...
install or a one-time `~/.swarmlo/metaharness-cache-<pin>` install, never
...
1. Run `node plugins/swarmlo-metaharness/scripts/score.mjs --path <dir>`
...
1. Run `node plugins/swarmlo-metaharness/scripts/genome.mjs --path <dir>`
...
1. Run `node plugins/swarmlo-metaharness/scripts/mcp-scan.mjs --path <dir>`
...
1. Run `node plugins/swarmlo-metaharness/scripts/threat-model.mjs --path <dir>`
...
1. Run `node plugins/swarmlo-metaharness/scripts/oia-audit.mjs`
...
1. Run `node plugins/swarmlo-metaharness/scripts/mint.mjs --name <id> --template <id> --host <id>`
2. **Safety**: refuses to write to the calling repo root or any path inside it; defaults to `/tmp/swarmlo-mint-<ts>-<name>/`

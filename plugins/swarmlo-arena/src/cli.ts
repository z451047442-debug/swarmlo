#!/usr/bin/env node
// Human-facing CLI for swarmlo-arena. Subcommands mirror the MCP tools (ADR-147).
//   swarmlo-arena demo | arena | tournament | evolve | coevolve
...
function cmdDemo(): void {
  console.log('============================================================');
  console.log(' swarmlo-arena — competitive ruliology demo (ADR-147/148/150)');
  console.log('============================================================');

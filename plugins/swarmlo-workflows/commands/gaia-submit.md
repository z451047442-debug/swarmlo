...
with the swarmlo Ed25519 witness manifest.
...
|------|---------|-------------|
| `--results` | `~/.cache/swarmlo/gaia/results-latest.json` | Path to the JSON results file from `/gaia run` |
...
1. Locate the results file — default `~/.cache/swarmlo/gaia/results-latest.json`;

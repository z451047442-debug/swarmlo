...
allowed-tools: Bash mcp__plugin_swarmlo-core_swarmlo__memory_store mcp__plugin_swarmlo-core_swarmlo__memory_search mcp__plugin_swarmlo-core_swarmlo__memory_list mcp__plugin_swarmlo-core_swarmlo__hooks_post_task mcp__plugin_swarmlo-core_swarmlo__hooks_pre_task
---
...
```bash
/gaia submit --results=~/.cache/swarmlo/gaia/results-latest.json
```
...
signed *into* the witness manifest as an ADR-103 fix marker, so a swarmlo GAIA
...
Interpret the gap between swarmlo's score and the leaderboard top-10.

/**
 * swarmlo-arena — Competitive ruliology for Swarmlo swarms (ADR-147/148).
 *
 ...
 * The presentation/dashboard layer lives in Swarmlo (ADR-150); the data/intelligence layer

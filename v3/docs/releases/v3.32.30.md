# Swarmlo v3.32.30: Capability Brain, Now Complete in the Public Install

Swarmlo can coordinate hundreds of agent, memory, policy, federation, and
...
- Ask `guidance_brain` which registered Swarmlo capabilities fit a task instead
...
```bash
npm install --global swarmlo@3.32.30
swarmlo doctor
```
...
- `swarmlo`, `claude-flow`, and `@claude-flow/cli` remain version-locked and

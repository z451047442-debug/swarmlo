...
allowed-tools: Bash(npx *) mcp__plugin_swarmlo-core_swarmlo__hooks_worker-dispatch Read Write Grep
---
...
Dispatch via MCP: `mcp__plugin_swarmlo-core_swarmlo__hooks_worker-dispatch({ trigger: "document", scope: "api" })`

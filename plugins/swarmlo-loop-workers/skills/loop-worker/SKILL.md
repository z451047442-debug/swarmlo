---
name: loop-worker
description: Run Swarmlo background workers using Claude Code native /loop scheduling
argument-hint: "<worker-name>"
allowed-tools: Bash(npx *) mcp__plugin_swarmlo-core_swarmlo__hooks_worker-dispatch mcp__plugin_swarmlo-core_swarmlo__hooks_worker-status ScheduleWakeup
---
...
Dispatch a worker via MCP: `mcp__plugin_swarmlo-core_swarmlo__hooks_worker-dispatch({ trigger: "WORKER_NAME" })`

...
```bash
npx swarmlo-cli@latest agent pool [options]
```
...
npx swarmlo-cli@latest agent pool

# Set pool size
npx swarmlo-cli@latest agent pool --size 5

# Configure auto-scaling
npx swarmlo-cli@latest agent pool --min 2 --max 15 --auto-scale

# Pre-warm agents for fast response
npx swarmlo-cli@latest agent pool --warmup

# Disable auto-scaling
npx swarmlo-cli@latest agent pool --auto-scale false
```
...
- `npx swarmlo-cli@latest agent spawn` - Manual agent spawning
- `npx swarmlo-cli@latest agent list` - View active agents
- `npx swarmlo-cli@latest swarm scale` - Swarm-level scaling

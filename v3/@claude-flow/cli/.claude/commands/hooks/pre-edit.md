...
```bash
npx swarmlo-cli@latest hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx swarmlo-cli@latest hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx swarmlo-cli@latest hook pre-edit --file "path/to/file.js" --validate-syntax
```

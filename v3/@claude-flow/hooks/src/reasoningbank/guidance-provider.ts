...
export class GuidanceProvider {
  ...
  async generateSessionContext(): Promise<string> {
    ...
    const lines = [
      ...
      '',
      '**Performance Targets (measured in-tree, 2026-08-31)**:',
      '- HNSW search: ~1.9x vs brute force at N=20k (150x-12,500x not reproduced)',
      '- Flash Attention: speedup not measured in-tree (upstream claim withdrawn)',
      '- Memory: int8 quantization 3.84x compression measured',
      '',
      '**Active Patterns**:',

 ...
 *
 * `swarmlo-neural-trader` does mean-variance optimisation: solve `Σ x = μ`
...
export function portfolioGraphId(portfolioId: string): string {
  return `swarmlo-neural-trader:covariance:${portfolioId}`;
}

export class PortfolioCovarianceAdapter implements SublinearAdapter {
  readonly graphId: string;
  readonly ownerPlugin = 'swarmlo-neural-trader';

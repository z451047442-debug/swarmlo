# Swarmlo v3.32.37: Complete Reports, Consistent Initialization

Swarmlo v3.32.37 closes the follow-up defects found while verifying v3.32.36
...
```bash
npm install --global swarmlo@3.32.37
swarmlo doctor
```

Existing projects remain compatible. The stable train still contains exactly
the three supported packages: `@claude-flow/cli`, `claude-flow`, and `swarmlo`.

## MetaHarness readiness is data

```bash
swarmlo metaharness genome --path . --format json
```

Upstream MetaHarness intentionally uses exit 1 for `needs-work` and exit 2 for
`blocked`. Swarmlo now preserves those valid reports instead of replacing them
...
The Swarmlo wrapper exits successfully for a valid report so CLI and MCP callers
...
- Every tracked shell and Windows hook shim now resolves the same stable Swarmlo
  dist-tag.
...
This patch resolves
[#2626](https://github.com/z451047442-debug/swarmlo/issues/2626),
[#2629](https://github.com/z451047442-debug/swarmlo/issues/2629),
[#2600](https://github.com/z451047442-debug/swarmlo/issues/2600),
[#2634](https://github.com/z451047442-debug/swarmlo/issues/2634),
[#2636](https://github.com/z451047442-debug/swarmlo/issues/2636),
[#2637](https://github.com/z451047442-debug/swarmlo/issues/2637),
[#2660](https://github.com/z451047442-debug/swarmlo/issues/2660),
[#2659](https://github.com/z451047442-debug/swarmlo/issues/2659),
[#2651](https://github.com/z451047442-debug/swarmlo/issues/2651),
[#2628](https://github.com/z451047442-debug/swarmlo/issues/2628), and
the remaining active-row visibility defect in
[#2652](https://github.com/z451047442-debug/swarmlo/issues/2652).

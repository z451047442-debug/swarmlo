# Swarmlo v3.32.36: Trustworthy Signals, Portable Codex Workflows

Swarmlo v3.32.36 makes the information an agent sees line up with what the
...
operate. Codex receives a native read-only Swarmlo status skill, dual-mode memory
...
```bash
npm install --global swarmlo@3.32.36
swarmlo doctor
```
...
```bash
swarmlo mcp start --tools memory,swarm,hooks
```

The equivalent environment form is useful in MCP host configuration:

```bash
CLAUDE_FLOW_MCP_TOOLS=memory,swarm,hooks swarmlo mcp start
```

Selectors accept categories, tool-name prefixes, and exact tool names. Swarmlo
doctor now reports catalog/schema overhead so the selection can be measured.

## Inspect grounded learning state

```bash
swarmlo embeddings status
swarmlo hooks metrics
swarmlo swarm status
swarmlo doctor --component memory
```
...
```bash
swarmlo memory distill run
swarmlo memory distill status
```
...
After initialization, Codex can invoke the native `swarmlo-status` skill without
...
- Swarmlo core hook integration passed 22/22, including duplicate-event
...
- The stable release workflow additionally installs and tests immutable tarball
  archives for `@claude-flow/cli`, `claude-flow`, and `swarmlo` before publishing
  those exact bytes.

This release resolves the current runtime and verification defects tracked in
[#2847](https://github.com/z451047442-debug/swarmlo/issues/2847),
[#2821](https://github.com/z451047442-debug/swarmlo/issues/2821),
[#2818](https://github.com/z451047442-debug/swarmlo/issues/2818),
[#2816](https://github.com/z451047442-debug/swarmlo/issues/2816),
[#2814](https://github.com/z451047442-debug/swarmlo/issues/2814),
[#2812](https://github.com/z451047442-debug/swarmlo/issues/2812),
[#2811](https://github.com/z451047442-debug/swarmlo/issues/2811),
[#2810](https://github.com/z451047442-debug/swarmlo/issues/2810),
[#2809](https://github.com/z451047442-debug/swarmlo/issues/2809),
[#2808](https://github.com/z451047442-debug/swarmlo/issues/2808),
[#2807](https://github.com/z451047442-debug/swarmlo/issues/2807),
[#2805](https://github.com/z451047442-debug/swarmlo/issues/2805),
[#2766](https://github.com/z451047442-debug/swarmlo/issues/2766),
[#2765](https://github.com/z451047442-debug/swarmlo/issues/2765),
[#2750](https://github.com/z451047442-debug/swarmlo/issues/2750),
[#2729](https://github.com/z451047442-debug/swarmlo/issues/2729),
[#2726](https://github.com/z451047442-debug/swarmlo/issues/2726),
[#2677](https://github.com/z451047442-debug/swarmlo/issues/2677),
[#2675](https://github.com/z451047442-debug/swarmlo/issues/2675), and
[#2674](https://github.com/z451047442-debug/swarmlo/issues/2674).

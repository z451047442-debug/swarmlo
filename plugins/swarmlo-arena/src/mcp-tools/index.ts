// MCP tools for swarmlo-arena (Swarmlo ADR-147/148). Tool shape matches the Swarmlo convention:
...
/**
 * Default tool set, persisting to `.swarmlo/arena/` under the process CWD.
 *

 ...
 * `mcp__swarmlo-sublinear__page-rank-entry` is not registered in the runtime.
 *
...
/**
 * True iff `mcp__swarmlo-sublinear__page-rank-entry` is registered in the
...
/**
 * Dispatch to `mcp__swarmlo-sublinear__page-rank-entry` when available, fall

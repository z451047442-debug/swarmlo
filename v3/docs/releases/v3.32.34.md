# Swarmlo v3.32.34: Reliable Memory Writes on Existing Installations
...
because the database is read-only, locked, or damaged, Swarmlo fails closed and
...
```bash
npm install --global swarmlo@3.32.34
swarmlo doctor
```
...
This release resolves [#2843](https://github.com/z451047442-debug/swarmlo/issues/2843) via
[#2844](https://github.com/z451047442-debug/swarmlo/pull/2844).

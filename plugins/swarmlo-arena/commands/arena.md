...
The MCP tools persist full artifacts to `.swarmlo/arena/<runId>.json` (exact replay). Each tool
...
Later: `mcp__plugin_swarmlo-core_swarmlo__memory_search({ namespace: "arena", query: "tournaments where grim dominated" })`.

...
allowed-tools: Bash Read Write Edit Grep Glob mcp__plugin_swarmlo-core_swarmlo__memory_store mcp__plugin_swarmlo-core_swarmlo__memory_search mcp__plugin_swarmlo-core_swarmlo__agentdb_hierarchical-store mcp__plugin_swarmlo-core_swarmlo__hooks_pre-task mcp__plugin_swarmlo-core_swarmlo__hooks_post-task
---
...
2. **Pre-task hook**: `npx swarmlo-cli@3.39.1 hooks pre-task --description "DDD aggregate: <aggregate-name> in <context>"`
...
9. **Store in domain model graph**:
   ```
   mcp__plugin_swarmlo-core_swarmlo__agentdb_hierarchical-store --parent "context:<context>" --child "aggregate:<aggregate-name>" --relation "contains"
...
10. **Post-task hook**: `npx swarmlo-cli@3.39.1 hooks post-task --task-id "ddd-aggregate-<aggregate-name>" --success true --train-neural true`

...
Steps:
1. `npx swarmlo-cli@latest security scan --depth DEPTH --target . --output json`
2. `npx swarmlo-cli@latest security cve --list`
3. `npx swarmlo-cli@latest security threats --model stride --export md`

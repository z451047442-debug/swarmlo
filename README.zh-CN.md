...
[![npm 版本 (swarmlo)](https://img.shields.io/npm/v/swarmlo?label=npx%20swarmlo&style=for-the-badge&logo=npm&color=cb3837)](https://www.npmjs.com/package/swarmlo)
...
[![生态下载量](https://img.shields.io/badge/ecosystem%20downloads-8.1M%2B-blue?style=flat-square&logo=npm)](https://github.com/z451047442-debug/swarmlo/blob/main/data/clone-data.proof.json)
[![Git 克隆数 (14天)](https://img.shields.io/badge/git%20clones%2014d-106k-blueviolet?style=flat-square&logo=github)](https://github.com/z451047442-debug/swarmlo/blob/main/data/clone-data.ledger.json)
...
<p align="center">
  <a href="https://flo.ruv.io/">
    <img src="v3/docs/assets/ruVocal.png" alt="Swarmlo Web UI 在 flo.ruv.io 上执行并行 MCP 工具调用 —— swarmlo__memory_store 与 swarmlo__memory_search 在单次模型回复中同时触发，带有 'Step 1 — 2 tools completed' 并行执行指示器，思考过程面板可见，当前模型为 Qwen 3.6 Max。支持 Model Context Protocol（MCP）工具调用的多智能体 AI 聊天，经由 AgentDB + HNSW 的持久化向量记忆、蜂群协调，以及 6 个前沿模型（包括 Claude Sonnet 4.6、Gemini 2.5 Pro 和经 OpenRouter 接入的 OpenAI）。" width="100%" />
  </a>
</p>
...
<p align="center">
  <a href="https://goal.ruv.io/agents">
    <img src="v3/docs/assets/goal.png" alt="goal.ruv.io/agents —— Swarmlo 面向自主 AI 智能体的目标导向动作规划（GOAP）UI。可视化目标分解、穿越状态空间的 A* 搜索、多智能体任务分配，以及实时智能体遥测。" width="100%" />
  </a>
</p>

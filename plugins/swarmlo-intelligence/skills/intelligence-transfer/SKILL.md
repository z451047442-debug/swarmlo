...
allowed-tools: mcp__plugin_swarmlo-core_swarmlo__hooks_transfer mcp__plugin_swarmlo-core_swarmlo__hooks_intelligence_pattern-search mcp__plugin_swarmlo-core_swarmlo__hooks_intelligence_pattern-store mcp__plugin_swarmlo-core_swarmlo__neural_patterns mcp__plugin_swarmlo-core_swarmlo__neural_status Bash
---
...
- `swarmlo-agentdb` ADR-0001 §"Namespace convention" — defines `pattern` namespace that this transfer reads from

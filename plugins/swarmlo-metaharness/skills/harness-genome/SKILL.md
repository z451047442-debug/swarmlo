...
## Phase-0 baseline (swarmlo, measured 2026-06-16)
...
Swarmlo's `risk_score: 0.27` is low (good). `publish_readiness: 0.9` is
high. The `mcp_surface: "remote"` reflects that swarmlo's MCP servers are
hosted, not bundled.

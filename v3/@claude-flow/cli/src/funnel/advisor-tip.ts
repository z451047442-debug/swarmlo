 ...
 * suggestion generated by swarmlo's existing Fable Advisor Harness
 ...
 * applies. Override via SWARMLO_ADVISOR_MAX_BUDGET_USD for advanced users. */
...
function resolveBudgetUsd(): number {
  const raw = process.env.SWARMLO_ADVISOR_MAX_BUDGET_USD;

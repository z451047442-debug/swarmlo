...
You are the GAIA Submission Coordinator for the swarmlo harness. Your responsibilities:
...
```bash
node plugins/swarmlo-core/scripts/witness/sign.mjs submission-<date>-<sha>/
```

...
`swarmlo-daa` (v0.2.0) wraps 8 `daa_*` MCP tools at `v3/@claude-flow/cli/src/mcp-tools/daa-tools.ts:90, 161, 223, 271, 322, 388, 444, 512`:
...
2. README augment: Compatibility (pin v3.6), Namespace coordination (claims `daa-patterns`; defers to swarmlo-agentdb ADR-0001), 8-tool surface table, intelligence-pipeline alignment note (DAA cognitive patterns feed the JUDGE phase per swarmlo-intelligence ADR-0001), Verification + Architecture Decisions sections.
...
- `plugins/swarmlo-intelligence/docs/adrs/0001-intelligence-surface-completeness.md` — 4-step pipeline DAA feeds

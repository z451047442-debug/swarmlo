...
npx swarmlo-cli@latest sparc run integration "connect payment service"

# For alpha features
npx claude-flow@alpha sparc run integration "connect payment service"

# With namespace
npx swarmlo-cli@latest sparc run integration "your task" --namespace integration

# Non-interactive mode
npx swarmlo-cli@latest sparc run integration "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx swarmlo-cli@latest memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx swarmlo-cli@latest memory query "integration" --limit 5
```

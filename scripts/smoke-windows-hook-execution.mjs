...
// Step 1: Generate settings.json via swarmlo init
const tmpDir = mkdtempSync(join(tmpdir(), 'swarmlo-smoke-hook-exec-'));
...
if (postEditCmd) {
  ...
  const env = {
    ...
    // swarmlo@latest` — that takes 30+s on a cold CI runner and exceeds

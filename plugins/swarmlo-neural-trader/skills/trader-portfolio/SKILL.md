...
7. Search for similar allocations in history:
   `mcp__plugin_swarmlo-core_swarmlo__agentdb_pattern-search({ query: "optimized portfolio Sharpe > 1", namespace: "trading-portfolio" })`
8. Store optimized allocation:
   `mcp__plugin_swarmlo-core_swarmlo__memory_store({ key: "portfolio-optimal-TIMESTAMP", value: "ALLOCATION_JSON", namespace: "trading-portfolio" })`

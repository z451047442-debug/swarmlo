...
allowed-tools: mcp__plugin_swarmlo-core_swarmlo__transfer_plugin-info Bash Read Glob Grep
---
...
10. **MCP tool references** — tools in `allowed-tools` are valid `mcp__plugin_swarmlo-core_swarmlo__*` identifiers

...
describe('generateAgentsMd', () => {
  ...
  describe('default template', () => {
    it('should generate a default AGENTS.md with all sections', async () => {
      ...
      expect(result).toContain('## Swarmlo + Codex Automated Workflow');
      ...
      expect(result).not.toContain('Co-Authored-By: swarmlo-bot');
    });
...
describe('generateConfigToml', () => {
  ...
  describe('default configuration', () => {
    it('should generate valid TOML with header', async () => {
      ...
      expect(result).toContain('# Documentation: https://github.com/z451047442-debug/swarmlo');
    });
    ...
    it('should include default swarmlo MCP server', async () => {
      const result = await generateConfigToml({ platform: 'linux' });
...
describe('generateCIConfigToml', () => {
  ...
  it('should generate a Windows-safe Swarmlo MCP command with startup headroom', async () => {

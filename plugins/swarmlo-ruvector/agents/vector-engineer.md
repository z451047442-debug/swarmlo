...
- **swarmlo-agentdb**: HNSW storage backend — persists indexes in AgentDB
- **swarmlo-intelligence**: Neural embeddings and SONA pattern learning
- **swarmlo-rag-memory**: Simple semantic search delegating to ruvector
- **swarmlo-knowledge-graph**: Graph RAG integration for multi-hop retrieval

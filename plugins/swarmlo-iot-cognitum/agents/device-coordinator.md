...
description: Manages Cognitum Seed device fleet as Swarmlo agent swarm members with 5-tier trust scoring
model: sonnet
---
...
```bash
npx swarmlo-cli@3.39.1 memory store --namespace iot-devices --key "device-DEVICEID" --value "TRUST_HISTORY"
```

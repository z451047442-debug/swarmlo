...
allowed-tools: Bash(npx *) mcp__plugin_swarmlo-core_swarmlo__memory_search Read Grep
...
2. `npx -y -p @claude-flow/plugin-agent-federation@latest swarmlo-federation audit --compliance MODE --since DATE --severity LEVEL`

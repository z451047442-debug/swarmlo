...
npx swarmlo-cli@latest sparc run docs-writer "create API documentation"

# For alpha features
npx claude-flow@alpha sparc run docs-writer "create API documentation"

# With namespace
npx swarmlo-cli@latest sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx swarmlo-cli@latest sparc run docs-writer "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx swarmlo-cli@latest memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx swarmlo-cli@latest memory query "docs-writer" --limit 5
```

# Give Your Coding Agent a Map of Swarmlo
...
Swarmlo v3.32.29 changes that. Its new MCP Capability Brain lets an agent inspect
the running Swarmlo system, see every registered capability, understand the
...
> Before implementing this task, call Swarmlo `guidance_brain` in `recommend`
...
- relevant Swarmlo capability domains;
...
An agent no longer needs a hard-coded list of Swarmlo features. It can discover
...
Swarmlo coordinates and records; the coding agent executes. Learning,
...
```bash
npm install --global swarmlo@3.32.29
swarmlo doctor
```
...
benchmark supplies evidence. A policy decision grants authority. Swarmlo keeps
those concepts separate.

## Further reading

- [ADR-325 — Claim Federation](https://github.com/z451047442-debug/swarmlo/blob/main/v3/docs/adr/ADR-325-claim-federation-zero-trust-capability-plane.md)
- [ADR-326 — Cognitum Product Plane](https://github.com/z451047442-debug/swarmlo/blob/main/v3/docs/adr/ADR-326-cognitum-product-plane-claim-federation.md)
- [ADR-327 — Concurrent Development Harness](https://github.com/z451047442-debug/swarmlo/blob/main/v3/docs/adr/ADR-327-federated-concurrent-development-harness.md)
- [ADR-328 — Assisted Agent Learning](https://github.com/z451047442-debug/swarmlo/blob/main/v3/docs/adr/ADR-328-cognitum-assisted-agent-learning.md)
- [ADR-329 — Capability Brain](https://github.com/z451047442-debug/swarmlo/blob/main/v3/docs/adr/ADR-329-swarmlo-capability-brain-mcp-guidance.md)

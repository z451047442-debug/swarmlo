 ...
 * `swarmlo` wrapper — the override MUST be present in BOTH the root umbrella
 * (`package.json`) and the wrapper (`swarmlo/package.json`). This guard asserts
...
const TARGETS = [
  ...
  { label: 'swarmlo (published wrapper)', path: 'swarmlo/package.json' },
];

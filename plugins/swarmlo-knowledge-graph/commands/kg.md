...
4. Store entities via `mcp__plugin_swarmlo-core_swarmlo__agentdb_hierarchical-store` in the `knowledge-graph` namespace
5. Create causal edges via `mcp__plugin_swarmlo-core_swarmlo__agentdb_causal-edge` for each relation
...
1. Look up the seed entity via `mcp__plugin_swarmlo-core_swarmlo__agentdb_hierarchical-recall`

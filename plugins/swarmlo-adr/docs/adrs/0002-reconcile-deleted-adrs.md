...
### 2. `plugins/swarmlo-adr/scripts/reindex.mjs`
...
- `plugins/swarmlo-adr/docs/adrs/0001-adr-plugin-pattern.md` — namespace ownership + smoke-as-contract this ADR continues
